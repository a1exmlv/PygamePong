...
image = pygame.image.load('PongSmall.png')
pygame.font.init()
...
while introOn:
    screen.fill(BLACK)
    textSurface = myFont.render('PONG GAME', False, (255, 255, 255))
    screen.blit(textSurface, (110, 25))
    textSurface = smallFont.render('By Alex M', False, (255, 255, 255))
...
while countOn:
    ...
    while True:
        for e in pygame.event.get():
            ...
            screen.fill((0, 0, 0))
            screen.blit(font.render(text, True, (255, 255, 255)), (250, 250))
            pygame.display.flip()
            clock.tick(60)
            if counter <= -1:
                countOn = False
...
while carryOn:
    ...
    textSurface = player.render('P1', False, (255, 0, 0))
    screen.blit(textSurface, (85, 15))
    textSurface = player.render('P2', False, (0, 0, 255))
...
while conclusionOn:
    screen.fill(BLACK)
    if scoreA > scoreB:
        textSurface = myFont.render('PLAYER 1 WINS!', False, (255, 0, 0))
        screen.blit(textSurface, (58, 200))
    elif scoreA < scoreB:
        textSurface = myFont.render('PLAYER 2 WINS!', False, (0, 0, 255))
        screen.blit(textSurface, (58, 200))
    else:
